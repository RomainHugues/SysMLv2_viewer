...
import { childNodes, nameOf, cstText, scopedDescendants, ownedElements } from "../ast";
...
export function extractSequence(pkg: SysmlNode): SequenceModel {
  ...
  for (const p of parts) add(nameOf(p));
